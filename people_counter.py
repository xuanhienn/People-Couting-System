...
def log_data(move_in, in_time, move_out, out_time):
	...
	# print("Move in ", move_in, "In time: ", in_time, "Move out: ", move_out, "Out time", out_time)
...
def people_counter():
	...
	while True:
		...
		cv2.putText(frame, "--", (10, H - ((i * 20) + 200)),
			...
			# to determine direction
				...
				if not to.counted:
					...
					if direction < 0 and centroid[1] < H // 2:
						...
						to.counted = True
						print("Total move out:", totalUp, "Out time:", date_time)
					...
					# center line, count the object
						...
						print("Total move in:", totalDown, "In time:", date_time)
